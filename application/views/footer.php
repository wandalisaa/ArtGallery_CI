	...
	<div class="search-model">
		<div class="h-100 d-flex align-items-center justify-content-center">
			...
			<form class="search-model-form" method="post" action="<?= base_url("search/index/") ?>">
				<input type="text" id="search-input" name="keyword" placeholder="Ketikkan Kata Kunci Disini.....">
			</form>
		</div>
	</div>
	<!-- Search End -->
