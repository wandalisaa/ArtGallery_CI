				...
				<form class="needs-validation" novalidate>
                    <div class="form-row">
                      <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="namaGaleri" placeholder="Galeri" value="" required>
                      ...
                      <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="deskGaleri" placeholder="Deskripsi" value="" required style="height: 100px;">
                        <div class="valid-feedback">
                          Bagus !
                        </div>
					  </div>
					  <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="kota" placeholder="Kota" value="" required >
                        <div class="valid-feedback">
                          Bagus !
                        </div>
					  </div>
					  <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="negara" placeholder="Negara" value="" required >
                        <div class="valid-feedback">
                          Bagus !
                        </div>
					  </div>
