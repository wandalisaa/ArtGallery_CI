				...
				<form class="needs-validation" method="post" action="<?=base_url('jenis/insert_jenis/')?>" novalidate>
                    <div class="form-row">
                      ...
                      <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" name="deskJenis" placeholder="Deskripsi ( optional )" value=""  style="height: 100px;">
                        <div class="valid-feedback">
                          Bagus !
                        </div>
								</div>
                        ...
                        <input type="number" class="form-control" name="tahunAkhir" placeholder="tahun akhir ( optional )" value="" >
                        <div class="valid-feedback">
                          Bagus !
                        </div>
					  			</div>
