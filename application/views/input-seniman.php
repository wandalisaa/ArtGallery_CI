				...
				<form class="needs-validation" novalidate method="post" action="<?= site_url('seniman/insert_seniman') ?>">
                    <div class="form-row">
                      ...
                      <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="deskSeniman" name="deskSeniman" placeholder="Deskripsi" value="" required style="height: 100px;">
                        <div class="valid-feedback">
                          Bagus !
                        </div>
											</div>
                        ...
                        <input type="date" class="form-control" id="tglSeniman" name="tanggalLahir"  placeholder="Tanggal Lahir" value="" required>
                        <div class="valid-feedback">
                          Bagus !
                        </div>
					  					</div>
