...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2021 at 05:07 PM
...
(15, 'Barok', 'The principal European style in the visual arts in the 17th century and the first half of the 18th; generally considered to be characteristic of the period of Caravaggio, Rubens, Rembrandt, Giordano and Tiepolo in painting, Bernini in sculpture, and Borromini, Fischer von Erlach and Wren in architecture. Usage of the term is often extended to the whole period 1600–1750 without qualifying restrictions, or improperly to mean a florid and elaborate style in art, architecture, music or literature, of any date from late antiquity to the early 20th century.', 1600, 1725),
...
(17, 19, 'Girl with a Pearl Earring', 'Girl with a Pearl Earring is Vermeer’s most famous painting. It is not a portrait, but a ‘tronie’ – a painting of an imaginary figure. Tronies depict a certain type or character; in this case a girl in exotic dress, wearing an oriental turban and an improbably large pearl in her ear.  Johannes Vermeer was the master of light. This is shown here in the softness of the girl’s face and the glimmers of light on her moist lips. And of course, the shining pearl.', 1665, '44.5 x 38.1 cm', 'images/Girl_with_a_Pearl_Earring.PNG', ''),
(18, 19, 'Judith and Holofernes', '', 1612, '', 'images/Judith_and_Holofernes.PNG', ''),
...
(19, 12, 1, 10, 15, '7 Contemporary Artists Inspired by Artemisia', 'Katy Hessel, founder of the Great Women Artists project, explores the enduring feminist spirit of Artemisia Gentileschi\r\n'),
(20, 0, 0, 11, 16, 'Five things about La Sylpide', 'August Bournonville’s La Sylphide, one of the oldest ballets in existence, was born from an 1832 French ballet by Filippo Taglioni which signalled the dawn of a new, Romantic era of ballet. Here are five facts about this captivating ballet.\r\n'),
(21, 0, 0, 12, 17, 'Sanctuary of Bom Jesus do Congonhas', 'A masterpiece of the Baroque style reflecting in its architecture and ornamentation the transition period in which it was built\r\n'),
(22, 0, 0, 13, 18, 'Be Colourful!', 'olish printed textiles and garments created between 1950 and 1989 from the collection of the Central Museum of Textiles in Lodz\r\n\r\n'),
(23, 0, 8, 14, 19, 'Carved images and symbols', 'Stone, wood, terracota and ivory sculpture '),
(24, 0, 0, 15, 20, 'Fashion in Spain: Contemporary Designers Making Their Mark', 'Half a century of Spanish fashion revealing the enormous potential of our most prominent creators.\r\n\r\n');
...
--
ALTER TABLE `tr_art`
  MODIFY `id_art` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `tr_fav`
  MODIFY `id_fav` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
